...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['Add_name'])) {
    	...
    	$statement = $pdo->prepare("SELECT * FROM tbl_Add WHERE Add_name=?");
    	$statement->execute(array($_POST['Add_name']));
    ...
    if($valid == 1) {
		...
		// Saving data into the main table tbl_Add
		$statement = $pdo->prepare("INSERT INTO tbl_Add (Add_name) VALUES (?)");
		$statement->execute(array($_POST['Add_name']));
	
    	$success_message = 'Add is added successfully.';
    }
}
?>
