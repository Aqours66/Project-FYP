			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Supplier</label>
							<div class="col-sm-4">
								<select name="supplier_name" class="form-control select2" required>
									<option value="">Select Supplier</option>
									<?php
									$statement = $pdo->prepare("SELECT supplier_name FROM tbl_supplier ORDER BY supplier_name ASC");
									$statement->execute();
									$result = $statement->fetchAll(PDO::FETCH_ASSOC);
									foreach ($result as $row) {
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Select CYL</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="add[]" class="form-control select2" multiple="multiple">
									...
									foreach ($result as $row) {
									?>
										<option value="<?php echo $row['Add_id']; ?>"><?php echo $row['Add_name']; ?></option>
									<?php
									}
									?>
								</select>
