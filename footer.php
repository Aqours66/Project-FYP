								...
								if (filter_var($_POST['email_subscribe'], FILTER_VALIDATE_EMAIL) === false) {
									...
									if ($total) {
										...
										try {
											...
											$mail->SMTPAuth   = true;
											$mail->Username   = 'ongweian1234@gmail.com';
											$mail->Password   = 'shkclnxfqzhnxsgg';
											$mail->SMTPSecure = 'tls';
											$mail->Port       = 587;
											...
											$mail->Subject = 'Subscriber Email Confirmation';

											// Generate the verification link using the $token variable
											$verificationLink = 'http://localhost/Lensify/verify1.php?token=' . $key;

											$mail->Body    = 'Thanks for your interest to subscribe to our newsletter!<br><br>
											Please click this link to confirm your subscription:<br><br> <a href="' . $verificationLink . '">Verify Account</a>';
